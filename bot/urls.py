...
urlpatterns = [
    ...
    url(r'^messages/$', views.message, name='messages-list'),
    url(r'^messages/(?P<id>[\d]+)/$', views.message, name='messages'),
    ...
    url(r'^news/(?P<member_id>[\d]+)/(?P<nid>[\d]+)/$', views.redirector, name='redirector'),

    url(r'^bot/$', views.bot, name='bot-list'),
    url(r'^bot/rule/add/$', views.rule_add, name='bot-rule-add'),
    url(r'^bot/setup/add/$', views.bot_setup, name='bot-setup'),
    url(r'^bot/setup/detail/(?P<type>[\w]+)/$', views.bot_setup_detail, name='bot-setup-details'),
    url(r'^bot/rule/detail/(?P<type>[\w]+)/$', views.rule_detail, name='bot-rule-detail'),

    url(r'^news/sources/$', views.sources, name='sources'),
    ...
    url(r'^member/promote/(?P<member_id>[\d]+)/$', views.member_promote, name='member-promote'),
    url(r'^member/demote/(?P<member_id>[\d]+)/$', views.member_demote, name='member-demote'),
    url(r'^member/reward/(?P<group_id>-?\d+)/(?P<member_id>-?\d+)/$', views.member, name='member-reward'),
    ...
    url(r'^test/$', views.callback, name='test'),
