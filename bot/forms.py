...
from bot.models import EngagementRule, Setup, NewsSource
...
class EngagementRuleForm(forms.Form):
    ...
    text_keywords = forms.CharField(required=False, widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Semi-column (;) separated list of keywords', "style": "width: 100%"}))
...
NewsSourceFormSet = modelformset_factory(NewsSource, form=NewsSourceForm, extra=1)
